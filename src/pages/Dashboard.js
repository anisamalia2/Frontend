          ...
          <div className="max-w-7xl mx-auto px-6 md:px-20 flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2">
              <img
                src={heroImg2}
                alt="hero2"
                className="w-[280px] sm:w-[350px] md:w-[480px] lg:w-[600px] ml-0 md:ml-[-40px]"
              />
            </div>
            <div className="md:w-1/2">
              <h2 className="text-4xl md:text-4xl font-extrabold text-slate-900 mb-4">
              ...
              {reviews.map((r, i) => (
                ...
                >
                  <div className="flex items-center gap-4 mb-4">
                    <div className="w-14 h-14 rounded-full bg-yellow-400 flex items-center justify-center font-bold text-xl flex-shrink-0">
                      {r.name[0]}
                    </div>
